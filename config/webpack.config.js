...
module.exports = function (webpackEnv) {
  ...
  return {
    ...
    // entry: paths.appIndexJs, //原来单页面的版本
    entry: {
      index: isEnvDevelopment && !shouldUseReactRefresh ? [ webpackDevClientEntry, paths.appIndexJs, ] : paths.appIndexJs,
      moreplayer: isEnvDevelopment && !shouldUseReactRefresh ? [ webpackDevClientEntry, paths.moreplayerIndexJs ] : paths.moreplayerIndexJs,
    },
